...
This plugin allows users to encrytp emails in their content and widgets using a simple shortcode. The encryption uses a native Wordpress function antispambot().
 
== Description ==
 
This plugin allows users to encrytp emails in their content and widgets using a simple shortcode. The encryption uses a native Wordpress function antispambot().
 
To encrypt your email simply use the shortcode [encrypt_email email="your@email-here.com" text="The text you want to be seen by users. Defaul: email"]
 
= Support =

* ["Github"](https://github.com/lukewatts/encrypt-email)
or
* ["Authors Website"](http://luke-watts.com/contact)
 
= Future Features =
* In the futuer there will be a TinyMCE button which will allow you to simply highlight your email in the content and wrap it in the shortcode which will encrypt it. For now you;ll have to simply type it.
